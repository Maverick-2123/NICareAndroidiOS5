...
class FirstPageState extends State<FirstPage> {
  ...
  List<Map> _myJson = [
    ...
    {'id': 1, 'image': 'assets/united-states.png', 'name': 'English','lang':'en'},
    {'id': 2, 'image': 'assets/spain.png', 'name': 'Español','lang':'es'},
    {'id': 3, 'image': 'assets/germany.png', 'name': 'Deutsch','lang':'de'},
    {'id': 4, 'image': 'assets/japan.png', 'name': '日本語','lang':'ja'},
    {'id': 5, 'image': 'assets/china.png', 'name': '汉语','lang':'zh'},
  ];
    ...
    showDialog(context: context, builder: (BuildContext ctx){
      return BackdropFilter(
        ...
        child: AlertDialog(
          ...
          content: Text(error_code+", please try again",style: AppTextStyles.regular(
              color: Colors.white, fontSize: 16, letterSpacing: 0.7)),
          actions: [
            TextButton(onPressed: (Navigator.of(context).pop), child: Text("Continue"))
          ],
        ),
      );
    });
                    ...
                    child: DropdownButtonHideUnderline(
                        child: ButtonTheme(
                          ...
                          child: DropdownButton<String>(
                            dropdownColor: Color(0xFF005AFF),
                            borderRadius: BorderRadius.circular(25),
                            isDense: true,
                            icon: Icon(
